			                  				...
			                  				<table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover" data-pagination="true" data-search="true" style="margin-top: 0px;">
			                    				<thead style="">
			                    					<tr>
														...
														<th style="" data-field="Weight" data-align="right">
			                    							<div class="th-inner ">Weight</div>
			                    							<div class="fht-cell"></div>
														</th>
														<th style="" data-field="unit" data-align="center">
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
														  ...
														  <td style=""><?=$product_detail['weight']; ?></td>
														<td style=""><?=$product_detail['unit_id']; ?></td>
														<td style=""><?=number_format($product_detail['price'],2);?></td>
														<td style="">
															<?php if ($product_detail['is_active'] == '1') : ?>
			                  							...
			                  							<td style=""><?=date("d/m/Y", strtotime($product_detail['update_date']) ); ?></td>
			                  							<td>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<h6>รายที่เลือกจะไม่แสดงผลในหน้าเว็บ</h6>
				</div>
