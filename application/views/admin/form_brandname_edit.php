...
<head>
	...
	<title>Brand name | Salepage</title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            ...
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/update_brandname');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
							  <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" >
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Name</label>
				                  	<input type="link" class="form-control" id="name" name="name" value="<?=$brandname[0]['name']; ?>" autocomplete="off" >
				                </div>
								
				                <div class="text-right">
				                	<input type="hidden" name="br_id" value="<?=$brandname[0]['id']; ?>">
